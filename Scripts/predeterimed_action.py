...
class DP0:
    ...
    def create_trajs(self):
        ...
        self.create_pos_traj(self.initial_xyz, [0.005597, -0.016910, -0.124627])
        self.create_ang_traj(self.initial_rpy, [2.826, 0.760896, 1.794671])
        self.create_grip_traj(self.initial_gr, [0.35])
        
        self.create_pos_traj(self.initial_xyz, [0.005597, -0.016910, -0.124627])
        self.create_ang_traj(self.initial_rpy, [2.826, 0.760896, 1.794671])
        self.create_grip_traj(self.initial_gr, [0.005])
        
        self.create_pos_traj(self.initial_xyz, [0.005597, -0.013505, -0.114627])
        self.create_ang_traj(self.initial_rpy, [2.826, 0.760896, 1.794671])
        self.create_grip_traj(self.initial_gr, [0.005])
        #
        self.create_pos_traj(self.initial_xyz, [0.005597, -0.01, -0.114627])
        self.create_ang_traj(self.initial_rpy, [2.826, 0.760896, 1.794671])
        self.create_grip_traj(self.initial_gr, [0.005])

        self.create_pos_traj(self.initial_xyz, [0.002239, 0.002239, -0.138060])
        self.create_ang_traj(self.initial_rpy, [3.20179, -0.806269, 1.839447])
        self.create_grip_traj(self.initial_gr, [0.0])

        self.create_pos_traj(self.initial_xyz, [0.002239, -0.013433, -0.129105])
        self.create_ang_traj(self.initial_rpy, [4.124507, -0.313732, -1.071001])
        self.create_grip_traj(self.initial_gr, [0.0])

        self.create_pos_traj(self.initial_xyz, [0.002239, -0.013433, -0.129105])
        self.create_ang_traj(self.initial_rpy, [4.617044, -0.313732, 0.406611])
        self.create_grip_traj(self.initial_gr, [0.0])
        #
        self.create_pos_traj(self.initial_xyz, [0.002239, -0.013433, -0.129105])
        self.create_ang_traj(self.initial_rpy, [3.017044, -0.813732, 1.206611])
        self.create_grip_traj(self.initial_gr, [0.0])
        ...
        self.create_pos_traj(self.initial_xyz, [0.002239, -0.013433, -0.129105])
        self.create_ang_traj(self.initial_rpy, [3.017044, -0.813732, 1.206611])
        self.create_grip_traj(self.initial_gr, [0.2])

        self.create_pos_traj(self.initial_xyz, [0.003478, -0.012433, -0.129105])
        self.create_ang_traj(self.initial_rpy, [3.017044, -0.863732, 1.206611])
        self.create_grip_traj(self.initial_gr, [0.35])
        ...
        self.create_pos_traj(self.initial_xyz, [0.003478, -0.012433, -0.129105])
        self.create_ang_traj(self.initial_rpy, [3.017044, -0.863732, 1.206611])
        self.create_grip_traj(self.initial_gr, [0.00])
        ...
        self.create_pos_traj(self.initial_xyz, [0.003478, -0.012433, -0.129105])
        self.create_ang_traj(self.initial_rpy, [3.1, -0.863732, 1.206611])
        self.create_grip_traj(self.initial_gr, [0.00])

        self.create_pos_traj(self.initial_xyz, [0.0, -0.003358, -0.140299])
        self.create_ang_traj(self.initial_rpy, [2.602687, -0.850746, 3.137954])
        self.create_grip_traj(self.initial_gr, [0.00])

        self.create_pos_traj(self.initial_xyz, [-0.003358, -0.007836, -0.141418])
        self.create_ang_traj(self.initial_rpy, [2.378806, -0.582090, 3.630491])
        self.create_grip_traj(self.initial_gr, [0.00])

        self.create_pos_traj(self.initial_xyz, [-0.011194, -0.011194, -0.142537])
        self.create_ang_traj(self.initial_rpy, [2.468358, -0.402985, 3.451387])
        self.create_grip_traj(self.initial_gr, [0.00])
...
# Determined Path 1, replaces gui object class with predetermined paths for the PSM to follow
class DP1:
    def __init__(self, obj_name, initial_xyz=[0, 0, 0], initial_rpy=[0, 0, 0], initial_gr=[0], range_xyz=1.0, range_rpy=3.14, resolution=0.0001):
        # Get initial starting values
        self.initial_xyz = initial_xyz
    ...
    def create_trajs(self):
        # Define paths
        self.create_pos_traj(self.initial_xyz, self.initial_xyz)
        self.create_ang_traj(self.initial_rpy, self.initial_rpy)
        self.create_grip_traj(self.initial_gr, [0.35])
        ...
        self.create_pos_traj(self.initial_xyz, [0.008955, -0.019030, -0.129104])
        self.create_ang_traj(self.initial_rpy, [2.729552, -0.522388, 1.309596])
        self.create_grip_traj(self.initial_gr, [0.35])

        self.create_pos_traj(self.initial_xyz, [0.011194, -0.017910, -0.139179])
        self.create_ang_traj(self.initial_rpy, [2.617612, -0.522388, 1.533477])
        self.create_grip_traj(self.initial_gr, [0.35])
        ...
        self.create_pos_traj(self.initial_xyz, [0.001194, -0.017910, -0.119179])
        self.create_ang_traj(self.initial_rpy, [2.617612, -0.522388, 1.533477])
        self.create_grip_traj(self.initial_gr, [0.35])
        ...
        self.create_pos_traj(self.initial_xyz, [-0.004478, -0.010075, -0.145896])
        self.create_ang_traj(self.initial_rpy, [2.990746, -0.671642, 3.137954])
        self.create_grip_traj(self.initial_gr, [0.35])
...
if __name__ == "__main__":
    ...
    if parsed_args.run_psm_one is True:
        ...
        if psm.base is not None:
            ...
            dp = DP1(arm_name + '/baselink', init_xyz, init_rpy, init_gr, 0.3, 10.0, 0.000001)
